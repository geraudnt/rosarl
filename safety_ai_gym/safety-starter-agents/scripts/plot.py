...
exp_name_replaces = {
    "cpo_PointGoal1":"CPO",
    "trpo_PointGoal1":"TRPO",
    "trpo_minmax_PointGoal1":"TRPO Minmax (Ours)",
    "trpo_lagrangian_PointGoal1":"TRPO Lagrangian",
}
        ...
        if 'progress.txt' in files:
            ...
            try:
                ...
                if 'exp_name' in config:
                    ...
                    if exp_name in exp_name_replaces:
                        exp_name = exp_name_replaces[exp_name]
            except:
