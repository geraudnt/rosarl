...
bench_goal_base = bench_base.copy('Goal', goal_all)
bench_goal_base.register('0-FlagUnsafe', goal0)
bench_goal_base.register('1-FlagUnsafe', goal1)
bench_goal_base.register('2-FlagUnsafe', goal2)

#=============================================================================#
#                                                                             #
#       TerminalUnsafe Goal Environments                                                     #
#                                                                             #
#=============================================================================#
...
bench_goal_base = bench_base.copy('Goal', goal_all)
bench_goal_base.register('0-TerminalUnsafe', goal0)
bench_goal_base.register('1-TerminalUnsafe', goal1)
bench_goal_base.register('2-TerminalUnsafe', goal2)
...
#=============================================================================#
#                                                                             #
#       FlagUnsafe Button Environments                                                   #
#                                                                             #
#=============================================================================#
...
bench_button_base = bench_base.copy('Button', button_all)
bench_button_base.register('0-FlagUnsafe', button0)
bench_button_base.register('1-FlagUnsafe', button1)
bench_button_base.register('2-FlagUnsafe', button2)

#=============================================================================#
#                                                                             #
#       TerminalUnsafe Button Environments                                                   #
#                                                                             #
#=============================================================================#
...
bench_button_base = bench_base.copy('Button', button_all)
bench_button_base.register('0-TerminalUnsafe', button0)
bench_button_base.register('1-TerminalUnsafe', button1)
bench_button_base.register('2-TerminalUnsafe', button2)
...
#     'unsafe_terminate':2,
#     }
# custom_dict.update(zero_base_dict)
# bench_custom_base = bench_base.copy('Custom', custom_dict)
# bench_custom_base.register('')
...
custom_dict.update(zero_base_dict)
bench_custom_base = bench_base.copy('Custom', custom_dict)
bench_custom_base.register('0', {
            'action_noise': 0,
        })
bench_custom_base.register('1', {
            'action_noise': 5,
        })
bench_custom_base.register('2', {
            'action_noise': 10,
        })